...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 53.0, 110.0, 69.0, 22.0 ],
					"text" : "metro 2000"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 42.5, 276.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.5, 157.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 430.0, 45.0, 45.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "z.credits.v01.bp.maxpat",
				"bootpath" : "~/Documents/school/tech pro/tutorial.02a.basic.rtcmix",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
